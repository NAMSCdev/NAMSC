...
########## COMPONENTS TARGET PROPERTIES Debug ########################################
    ...
    ########## COMPONENT Boost::stacktrace_windbg_cached #############
        ...
        set(boost_Boost_stacktrace_windbg_cached_FRAMEWORKS_FOUND_DEBUG "")
        conan_find_apple_frameworks(boost_Boost_stacktrace_windbg_cached_FRAMEWORKS_FOUND_DEBUG "${boost_Boost_stacktrace_windbg_cached_FRAMEWORKS_DEBUG}" "${boost_Boost_stacktrace_windbg_cached_FRAMEWORK_DIRS_DEBUG}")
        ...
        set_property(TARGET boost_Boost_stacktrace_windbg_cached_DEPS_TARGET
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_FRAMEWORKS_FOUND_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_SYSTEM_LIBS_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_DEPENDENCIES_DEBUG}>
                     APPEND)

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'boost_Boost_stacktrace_windbg_cached_DEPS_TARGET' to all of them
        conan_package_library_targets("${boost_Boost_stacktrace_windbg_cached_LIBS_DEBUG}"
                              "${boost_Boost_stacktrace_windbg_cached_LIB_DIRS_DEBUG}"
                              "${boost_Boost_stacktrace_windbg_cached_BIN_DIRS_DEBUG}" # package_bindir
                              "${boost_Boost_stacktrace_windbg_cached_LIBRARY_TYPE_DEBUG}"
                              "${boost_Boost_stacktrace_windbg_cached_IS_HOST_WINDOWS_DEBUG}"
                              ...
                              "${boost_Boost_stacktrace_windbg_cached_NO_SONAME_MODE_DEBUG}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Boost::stacktrace_windbg_cached
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_OBJECTS_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_LIBRARIES_TARGETS}>
                     APPEND)

        if("${boost_Boost_stacktrace_windbg_cached_LIBS_DEBUG}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Boost::stacktrace_windbg_cached
                         PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_LINKER_FLAGS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_INCLUDE_DIRS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_LIB_DIRS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_COMPILE_DEFINITIONS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg_cached PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_cached_COMPILE_OPTIONS_DEBUG}> APPEND)

    ########## COMPONENT Boost::stacktrace_windbg #############

        set(boost_Boost_stacktrace_windbg_FRAMEWORKS_FOUND_DEBUG "")
        conan_find_apple_frameworks(boost_Boost_stacktrace_windbg_FRAMEWORKS_FOUND_DEBUG "${boost_Boost_stacktrace_windbg_FRAMEWORKS_DEBUG}" "${boost_Boost_stacktrace_windbg_FRAMEWORK_DIRS_DEBUG}")
        ...
        set_property(TARGET boost_Boost_stacktrace_windbg_DEPS_TARGET
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_FRAMEWORKS_FOUND_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_SYSTEM_LIBS_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_DEPENDENCIES_DEBUG}>
                     APPEND)

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'boost_Boost_stacktrace_windbg_DEPS_TARGET' to all of them
        conan_package_library_targets("${boost_Boost_stacktrace_windbg_LIBS_DEBUG}"
                              "${boost_Boost_stacktrace_windbg_LIB_DIRS_DEBUG}"
                              "${boost_Boost_stacktrace_windbg_BIN_DIRS_DEBUG}" # package_bindir
                              "${boost_Boost_stacktrace_windbg_LIBRARY_TYPE_DEBUG}"
                              "${boost_Boost_stacktrace_windbg_IS_HOST_WINDOWS_DEBUG}"
                              boost_Boost_stacktrace_windbg_DEPS_TARGET
                              boost_Boost_stacktrace_windbg_LIBRARIES_TARGETS
                              "_DEBUG"
                              "boost_Boost_stacktrace_windbg"
                              "${boost_Boost_stacktrace_windbg_NO_SONAME_MODE_DEBUG}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Boost::stacktrace_windbg
                     PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_OBJECTS_DEBUG}>
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_LIBRARIES_TARGETS}>
                     APPEND)

        if("${boost_Boost_stacktrace_windbg_LIBS_DEBUG}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Boost::stacktrace_windbg
                         PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_LINKER_FLAGS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_INCLUDE_DIRS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_LIB_DIRS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_COMPILE_DEFINITIONS_DEBUG}> APPEND)
        set_property(TARGET Boost::stacktrace_windbg PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${boost_Boost_stacktrace_windbg_COMPILE_OPTIONS_DEBUG}> APPEND)
