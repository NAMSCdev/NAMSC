...
public:
	...
	ActionFilterSaturation( Event *parent, uint actionID, QString &&label, QString &&sceneryObjectName, double intensivness, 
...
signals:
	...
	void onRun(SceneryObject *sceneryObject, QPoint pos, QSize size, double intensivness, uint strength, int addedSaturation, double percentSaturation);
