...
class SceneryBackgroundImageAsset final : public ImageAsset
{
public:
	SceneryBackgroundImageAsset() = default;
	SceneryBackgroundImageAsset(QString &&URI, QString &&location, unsigned pos = 0) : 
...
protected:
	...
	SerializationID			getType	() const override	{ return SerializationID::SceneryBackgroundImageAsset; }
};