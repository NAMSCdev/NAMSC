...
public:
	...
	ActionStatChange(unsigned actionID, QString &&statName, QString &&expression, QString &&label) :
		ActionStat(actionID, move(statName), move(label)), expression(move(expression)) {}
