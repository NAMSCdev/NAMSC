...
public:
	...
	void visitActionSceneryObjectAnim(ActionSceneryObjectAnim *action) override		{ changeID(action); }
	void visitActionSceneryObjectHide(ActionSceneryObjectHide *action) override		{ changeID(action); }
	void visitActionSceneryObjectShow(ActionSceneryObjectShow *action) override		{ changeID(action); }

	///[optional]
	void visitActionStatHide(ActionStatHide *action) override						{ changeID(action); }
